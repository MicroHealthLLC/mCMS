...
require_dependency 'award_enum'
require_dependency 'award_type'
...
require_dependency 'deployment_operation'
require_dependency 'discharge_type'
...
require_dependency 'incident_category'
require_dependency 'incident_type'
require_dependency 'installation_name'
...
require_dependency 'line_of_duty_investigation'
...
require_dependency 'unit_enum'
require_dependency 'unit_type'
require_dependency 'verified_personnel_casualty_reporting_system'
