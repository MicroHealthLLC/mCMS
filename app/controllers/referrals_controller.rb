class ReferralsController < ApplicationController
  ...
  private
    ...
    def referral_params
      params.require(:referral).permit(:user_id, :title, :referral_type_id, :referral_date, :referral_appointment, :referral_status_id, :referred_by_id, :referred_to_id, :referral_reason)
    end
end
