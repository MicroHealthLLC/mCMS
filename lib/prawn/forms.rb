...
module Prawn
  module Forms
    ...
    def button(text)
      add_interactive_field(:Btn, :T => String.new(text),
                            :DA => String.new("/Helv 0 Tf 0 g"),
                            :F => 4,
                            :Ff => 65536,
                            :MK => {:CA => String.new(text), :BG => [0.75294, 0.75294, 0.75294], :BC => [0.75294, 0.75294, 0.75294]},
    ...
    def text_field(name, x, y, w, h, opts = {})
      ...
      if opts[:default]
        field_dict[:V] = String.new(opts[:default])
      end
