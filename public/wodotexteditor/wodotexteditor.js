...
//            runtime.assert(editorSession, "editorSession should exist here.");
            runtime.assert(editorSession, "editorSession should exist here. - from startEditing 381");
        ...
        function endEditing() {
//            runtime.assert(editorSession, "editorSession should exist here.");
            runtime.assert(editorSession, "editorSession should exist here. - from endEditing 394");
        ...
        //    runtime.assert(editorSession, "editorSession should exist here.");
            runtime.assert(editorSession, "editorSession should exist here. - from setMetadata 515");
        ...
        //    runtime.assert(editorSession, "editorSession should exist here.");
            runtime.assert(editorSession, "editorSession should exist here. - from getMetadata 530");
        ...
        //    runtime.assert(editorSession, "editorSession should exist here.");
            runtime.assert(editorSession, "editorSession should exist here. - from setDocumentModifed 576");
        ...
        //    runtime.assert(editorSession, "editorSession should exist here.");
            runtime.assert(editorSession, "editorSession should exist here. - from isDocumentModifed 591");
