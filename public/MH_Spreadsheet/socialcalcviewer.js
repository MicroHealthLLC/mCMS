...
alert('top of SpreadsheetViewerLoadSave');
   var rmstr, pos, t, t2;

   var parts = spreadsheet.DecodeSpreadsheetSave(savestr);
   if (parts) {
      if (parts.sheet) {
alert('parts.sheet: call function ResetSheet');
         spreadsheet.sheet.ResetSheet();
alert('parts.sheet: call function ParseSheetSave');
         spreadsheet.sheet.ParseSheetSave(savestr.substring(parts.sheet.start, parts.sheet.end));
         }
      if (parts.edit) {
alert('parts.edit: call function LoadEditorSettings');
...
alert('parts.startupmacro: call function EditorScheduleSheetCommands');
...
alert('call function ScheduleRender');
      spreadsheet.editor.ScheduleRender();
      }
   else {
alert('call function EditorScheduleSheetCommands');
      spreadsheet.editor.EditorScheduleSheetCommands("recalc");
      }
alert('bottom of SpreadsheetViewerLoadSave');
   }
