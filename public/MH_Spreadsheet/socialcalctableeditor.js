...
SocialCalc.PositionTableControlElements = function(control) {
   ...
   if (control.vertical) {
      border = control.controlborder  - $('#left-panel').width() +"px";
      control.endcap.style.top = control.endcapstart - 59 +"px";
      control.endcap.style.left = border;
      control.paneslider.style.top = control.panesliderstart - 59+"px";
      control.paneslider.style.left = border
      control.lessbutton.style.top = control.lessbuttonstart - 59 +"px";
      control.lessbutton.style.left = border;
      control.morebutton.style.top = control.morebuttonstart - 59 +"px";
      control.morebutton.style.left = border;
      control.scrollarea.style.top = control.scrollareastart - 59+"px";
      ...
      border = control.controlborder - 59 +"px";
      control.endcap.style.left = control.endcapstart  - $('#left-panel').width() +"px";
      control.endcap.style.top = border;
      control.paneslider.style.left = control.panesliderstart- $('#left-panel').width() +"px";
      control.paneslider.style.top = border
      control.lessbutton.style.left = control.lessbuttonstart- $('#left-panel').width() +"px";
      control.lessbutton.style.top = border;
      control.morebutton.style.left = control.morebuttonstart- $('#left-panel').width() +"px";
      control.morebutton.style.top = border;
      control.scrollarea.style.left = control.scrollareastart- $('#left-panel').width() +"px";
