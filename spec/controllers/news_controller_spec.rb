...
RSpec.describe NewsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested new as @new" do
      new = New.create! valid_attributes
      get :show, params: {id: new.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested new as @new" do
      new = New.create! valid_attributes
      get :edit, params: {id: new.to_param}, session: valid_session
      expect(assigns(:new)).to eq(new)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new New" do
        expect {
          post :create, params: {new: valid_attributes}, session: valid_session
      ...
      it "assigns a newly created new as @new" do
        ...
        expect(assigns(:new)).to be_persisted
      end

      it "redirects to the created new" do
        post :create, params: {new: valid_attributes}, session: valid_session
        expect(response).to redirect_to(New.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved new as @new" do
        post :create, params: {new: invalid_attributes}, session: valid_session
        expect(assigns(:new)).to be_a_new(New)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested new" do
        new = New.create! valid_attributes
        put :update, params: {id: new.to_param, new: new_attributes}, session: valid_session
        new.reload
      ...
      it "assigns the requested new as @new" do
        new = New.create! valid_attributes
        put :update, params: {id: new.to_param, new: valid_attributes}, session: valid_session
        expect(assigns(:new)).to eq(new)
      end
    ...
    context "with invalid params" do
      it "assigns the new as @new" do
        new = New.create! valid_attributes
        put :update, params: {id: new.to_param, new: invalid_attributes}, session: valid_session
        expect(assigns(:new)).to eq(new)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested new" do
      new = New.create! valid_attributes
      expect {
        delete :destroy, params: {id: new.to_param}, session: valid_session
      }.to change(New, :count).by(-1)
    end
