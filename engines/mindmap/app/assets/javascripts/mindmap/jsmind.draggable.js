...
(function($w){
    ...
    if(!MHMind){return;}
    if(typeof MHMind.draggable != 'undefined'){return;}

    var jdom = MHMind.util.dom;
    ...
    MHMind.draggable.prototype = {
        ...
        _lookup_close_node:function(){
            ...
            var direct = (sx + sw/2)>=root_x ?
                            MHMind.direction.right : MHMind.direction.left;
            ...
            for(var nodeid in nodes){
                ...
                if(node.isroot || node.direction == direct){
                    ...
                    if(direct == MHMind.direction.right){
        ...
        move_node:function(src_node,target_node,target_direct){
            ...
            if(!!target_node && !!src_node && !MHMind.node.inherited(src_node, target_node)){
                // lookup before_node
    ...
    var draggable_plugin = new MHMind.plugin('draggable',function(jm){
        var jd = new MHMind.draggable(jm);
        jd.init();
    ...
    MHMind.register_plugin(draggable_plugin);
