...
function saveNotes() {
    ...
    thesenotes2 = localStorage.getItem("thesenotes");
    if(thesenotes != thesenotes2 )
    {
        $.getScript('/sticky_notes/sticky_notes/save.js?todos='+thesenotes, function( data, textStatus, jqxhr ) {
